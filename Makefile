...
ENV_VARIABLE_LIST	+= WP_ADMIN_USER
ENV_VARIABLE_LIST	+= WP_ADMIN_EMAIL
ENV_VARIABLE_LIST	+= WP_ADMIN_PASSWORD
ENV_VARIABLE_LIST	+= WP_SUBSCRIBER_USER
ENV_VARIABLE_LIST	+= WP_SUBSCRIBER_EMAIL
ENV_VARIABLE_LIST	+= WP_SUBSCRIBER_PASSWORD
ENV_VARIABLE_LIST	+= MYSQL_ROOT_PASSWORD
ENV_VARIABLE_LIST	+= MYSQL_USER
ENV_VARIABLE_LIST	+= MYSQL_PASSWORD
...
$(call check_defined, $(ENV_VARIABLE_LIST), $(MISSING_VAR_HELP))
endif
